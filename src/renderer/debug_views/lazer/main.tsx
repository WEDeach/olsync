                ...
                <Stack sx={{ height: "100%" }} spacing={2}>
                    ...
                    <div>
                        ...
                        <TextField
                            ...
                            label="Outlined"
                            variant="outlined"
                            value={this.controller.Path}
                        />
                    </div>
                    <div>
                        <Button
                            variant="contained"
                            onClick={this.controller.onReadLazerBtnClicked}
                            disabled={this.controller.Path.length === 0}
                        >
                            讀取檔案
                        </Button>
                        <Button
                            variant="contained"
                            onClick={this.controller.onCloseLazerBtnClicked}
                            disabled={this.controller.Path.length === 0}
                        >
                            關閉檔案
                        </Button>
                        ...
                        {s_tables.map((t) => {
                            return (
                                <Button
                                    key={t}
                                    variant="contained"
                                    onClick={() => this.controller.onSchemaBtnClicked(t)}
                                >
                                    {t}
                                </Button>
                            );
